...
5. 설정 화면이 나타나면 Name에 원하는 고유 이름(예: `hany-waiting`)을 적습니다. 
6. 스크롤을 살짝 내려 **Publish Directory** 칸에 점 한 개 **`.`** 를 입력합니다. (나머지는 그대로 둡니다.)
7. 화면 맨 아래의 파란색 **[Create Static Site]** 버튼을 누릅니다.
